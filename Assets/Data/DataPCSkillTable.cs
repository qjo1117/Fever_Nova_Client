...
[System.Serializable]
public class DataPCSkillTable
{
    public List<PCSkillTable> listPCSkillTable = new List<PCSkillTable>();
    ...
    public void DataParsing()
    {
        ...
        foreach(var item in data) {
            PCSkillTable info = new PCSkillTable();
    ...
    public PCSkillTable At(int _index)
	{
